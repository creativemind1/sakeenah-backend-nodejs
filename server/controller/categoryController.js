        ...
        case 'LOAD':
            {
                if (req.body.companyId) {
                    CategoryModel.find({ companyId: req.body.companyId }, function(err, doc) {
                        if (doc) {
                            res.json({
                                status: 'SUCCESS',
                                message: doc,
...
exports.subCategory = function(req, res) {
    ...
    switch (type) {
        ...
        case 'DELETE':
            {
                if (req.body.subCategoryId) {
                    SubCategoryModel.deleteOne({ subCategoryId: req.body.subCategoryId }, function(
                        err,
                        doc
                    ) {
                        if (doc && doc.deletedCount == 1) {
        ...
        case 'LOAD':
            {
                if (req.body.companyId) {
                    SubCategoryModel.find({ companyId: req.body.companyId }, function(err, doc) {
                        if (doc) {
                            res.json({
                                status: 'SUCCESS',
                                message: doc,
...
exports.media = function(req, res) {
    ...
    switch (type) {
        ...
        case 'DELETE':
            {
                if (req.body.mediaId) {
                    MediaModel.deleteOne({ mediaId: req.body.mediaId }, function(err, doc) {
                        if (doc && doc.deletedCount == 1) {
                            res.json({
                                status: 'SUCCESS',
        ...
        case 'LOAD':
            {
                if (req.body.companyId) {
                    MediaModel.find({ companyId: req.body.companyId }, function(err, doc) {
                        if (doc) {
                            res.json({
                                status: 'SUCCESS',
                                message: doc,
...
exports.playlist = function(req, res) {
    ...
    switch (type) {
        ...
        case 'DELETE':
            {
                if (req.body.audioID) {
                    PlayListModel.deleteOne({ audioID: req.body.audioID }, function(err, doc) {
                        if (doc && doc.deletedCount == 1) {
                            res.json({
                                status: 'SUCCESS',
        ...
        case 'LOAD':
            {
                if (req.body.companyId) {
                    PlayListModel.find({ companyId: req.body.companyId }, function(err, doc) {
                        if (doc) {
                            res.json({
                                status: 'SUCCESS',
                                message: doc,
